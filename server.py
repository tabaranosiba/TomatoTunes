...
def make_tomato():
    return render_template("make.html", song_database=song_database, playlists=playlists, selected_results=selected_results, current_id=current_id, playlist_id=playlist_id, playlist_length=playlist_length)

@app.route('/show_tomatoes')
def show_tomatoes():
    return render_template("playlists.html", song_database=song_database, playlists=playlists,selected_results=selected_results, current_id=current_id, playlist_id=playlist_id, playlist_length = playlist_length)

@app.route('/play/<playlist_id>', methods=['GET'])
def play(playlist_id):
    global playlists
    playlist_id = playlist_id
    return render_template('play.html', playlist_id = playlist_id, playlists = playlists, song_database=song_database, selected_results=selected_results, current_id=current_id, playlist_length=playlist_length) 
